...
APPLICATION_NAME: str = colour_visuals.__application_name__

APPLICATION_VERSION: str = colour_visuals.__version__

PYTHON_PACKAGE_NAME: str = colour_visuals.__name__

PYPI_PACKAGE_NAME: str = "colour-visuals"
